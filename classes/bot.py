...
class ModMail(commands.AutoShardedBot):
    ...
    async def connect_redis(self):
        self.redis = await aioredis.create_pool("redis://default:nur6fv3JTdtA60y4GMV2@containers-us-west-4.railway.app:6097", password="nur6fv3JTdtA60y4GMV2", minsize=5, maxsize=10, loop=self.loop, db=0)
